...
SEED_STORIES = [
    {
        ...
        "read_time": 3,
        "why_this_matters": "Negotiations for a global plastics treaty represent the first coordinated effort to place a legally binding limit on global synthetic waste production, which is currently projected to triple by 2060."
    },
    {
        "rank": 2,
...
10. WHY IT MATTERS: Set 'why_this_matters' to a concise, single-sentence summary explaining why this story deserves editorial attention.
